...
//                eclipse.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setTitle("Stream Deck Plugin Creator (v"+PluginCreator.VERSION_CODE+")");
        ...
        exists.setFont(new java.awt.Font("Consolas", 1, 20)); // NOI18N
        exists.setText("OK");
    ...
    private void netbeansActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_netbeansActionPerformed
        if(projectName.getText().isEmpty()){
            ...
            createFile("ui/netbeans/MyManager.java.txt",       name + "/src/" + name.toLowerCase() + "/MyManager.java", name, false);
            
            try {
                placeLib(name + "/lib/PluginCreator.v" + PluginCreator.VERSION_CODE + ".jar");
