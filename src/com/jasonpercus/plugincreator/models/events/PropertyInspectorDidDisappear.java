...
/**
 * This class represents an event when the property inspector disappears for a given action
 * @author JasonPercus
 * @version 1.0
 */
public final class PropertyInspectorDidDisappear extends Event {
